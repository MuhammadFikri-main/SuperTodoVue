<template>
  <div class="p-4 sm:ml-0">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="flex items-center justify-center h-20 pr-32 pl-32 rounded bg-gray-50 dark:bg-gray-800">
        ...
        <div class="pb-4 pr-32 pl-32 rounded bg-gray-50 dark:bg-gray-800">
          <div class="flex items-center ps-4 mb-4 border border-gray-200 rounded dark:border-gray-700">
